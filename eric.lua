...
TheBasicsQ = Redis:sismember(Tshak.."Tshak:TheBasicsQ:Group"..ChatId,UserId) 
...
Status = Redis:get(Tshak.."Tshak:DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(Tshak.."Tshak:PresidentQ:Group:Reply"..ChatId) or 'المالك'
...
ktmall = Redis:sismember(Tshak.."Tshak:ktmAll:Groups",UserId) ,
...
elseif Redis:sismember(Tshak.."Tshak:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Tshak.."Tshak:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
...
if text and Redis:get(Tshak.."Tshak:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Tshak.."Tshak:All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(Tshak.."Tshak:All:Get:Reides:Commands:Group"..text)
Redis:del(Tshak.."Tshak:All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Tshak.."Tshak:All:Command:List:Group",text)
...
Redis:del(Tshak.."Tshak:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Tshak.."Tshak:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Tshak.."Tshak:All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Tshak.."Tshak:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Tshak.."Tshak:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Tshak.."Tshak:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Tshak.."Tshak:All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Tshak.."Tshak:All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(Tshak.."Tshak:All:Command:List:Group",text)
Redis:del(Tshak.."Tshak:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
...
if Redis:get(Tshak.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Tshak.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(Tshak.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Tshak.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(Tshak.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Tshak.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(Tshak.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Tshak.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Tshak.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Tshak.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(Tshak.."Tshak:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ⦁ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(Tshak.."Tshak:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Tshak.."Tshak:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Tshak.."Tshak:Set:Id:Groups",text:match("(.*)"))
...
if text then
local NewCmmd = Redis:get(Tshak.."Tshak:All:Get:Reides:Commands:Group"..text) or Redis:get(Tshak.."Tshak:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/sourceTshak'}, },}}
...
--download('https://raw.githubusercontent.com/M2007A/JEKA/master/Tshak.lua','Tshak.lua')
...
Redis:del(Tshak.."Tshak:SendBcBot") 
...
Redis:set(Tshak.."Tshak:SendBcBot",true) 
...
Redis:set(Tshak.."Tshak:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(Tshak.."Tshak:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Tshak.."Tshak:AddSudosNew"..msg_chat_id)
...
Redis:set(Tshak.."Tshak:AddSudosNew"..msg_chat_id,true)
...
local UserInfo = LuaTele.getUser(Tshak)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NamesBot = (Redis:get(Tshak.."Tshak:Name:Bot") or "تشاك")
Groups = (Redis:scard(Tshak..'Tshak:ChekBotAdd') or 0)
Users = (Redis:scard(Tshak..'Tshak:Num:User:Pv') or 0)
...
{
{text = Jabwa, url = 't.me/sourceTshak'}, 
},
{
{text = Grosupsw, url = 't.me/sourceTshak'}, 
},
{
{text = Usperos, url = 't.me/sourceTshak'}, 
},
}
...
Get_Is_Id = Redis:get(Tshak.."Tshak:Set:Id:Groups") or Redis:get(Tshak.."Tshak:Set:Id:Group"..msg_chat_id)
...
local TotalMsg = Redis:get(Tshak..'Tshak:Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(Tshak..'Tshak:Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(Tshak.."Tshak:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Tshak.."Tshak:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
if text == 'رتبتي' then
if not Redis:get(Tshak.."Tshak:photo:Rank"..msg_chat_id) then
return false
end
...
if not Redis:sismember(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Tshak.."Tshak:PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:del(Tshak.."Tshak:PresidentQ:Group:Reply"..msg.chat_id)
...
local Info_Members = Redis:smembers(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Tshak.."Tshak:ktmAll:Groups") 
if #Info_Members == 0 then
...
Redis:set(Tshak.."Tshak:Zhrf:Sasa"..msg_chat_id,true) 
...
Redis:set(Tshak.."Tshak:photo:Rank"..msg_chat_id,true) 
...
if TextMsg == 'التحقق' then
    Redis:set(Tshak.."Tshak:Status:joinet"..msg_chat_id,true) 
...
Redis:set(Tshak.."Tshak:Sasa:Jeka"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم تفعيل ردود السورس *","md",true)
end
if TextMsg == 'نزلني' then
Redis:set(Tshak.."Tshak:Status:remMe"..msg_chat_id,true) 
...
Redis:del(Tshak.."Tshak:Zhrf:Sasa"..msg_chat_id) 
...
Redis:del(Tshak.."Tshak:photo:Rank"..msg_chat_id) 
...
if TextMsg == 'التحقق' then
    Redis:del(Tshak.."Tshak:Status:joinet"..msg_chat_id) 
...
if TextMsg == 'ردود السورس' then
Redis:del(Tshak.."Tshak:Sasa:Jeka"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم تعطيل ردود السورس *","md",true)
end
if TextMsg == 'نزلني' then
Redis:del(Tshak.."Tshak:Status:remMe"..msg_chat_id) 
...
if Redis:sismember(Tshak.."Tshak:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Tshak.."Tshak:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Tshak.."Tshak:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(Tshak.."Tshak:ktmAll:Groups",UserId_Info.id) 
...
if Redis:sismember(Tshak.."Tshak:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Tshak.."Tshak:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Tshak.."Tshak:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Tshak.."Tshak:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Tshak.."Tshak:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Tshak.."Tshak:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Tshak.."Tshak:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Tshak.."Tshak:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if text == "نزلني" then
if not Redis:get(Tshak.."Tshak:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(Tshak.."Tshak:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Tshak.."Tshak:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Tshak.."Tshak:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Tshak.."Tshak:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Tshak.."Tshak:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Tshak.."Tshak:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Tshak.."Tshak:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Tshak.."Tshak:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Tshak.."Tshak:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Tshak.."Tshak:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if not msg.ControllerBot and not Redis:set(Tshak.."Tshak:LeftBot") then
...
Redis:set(Tshak.."Tshak:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Tshak.."Tshak:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Tshak.."Tshak:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(Tshak.."Tshak:All:Get:Reides:Commands:Group"..v)
Redis:del(Tshak.."Tshak:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(Tshak.."Tshak:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
data = {
{
{text = '𓄼• سورس تشاك •𓄹', url = 't.me/sourceTshak'}, 
},
}
}
...
LuaTele.sendText(msg_chat_id,msg_id,'*☽ عدد جهاتك يبشا ⇦ '..(Redis:get(Tshak.."Tshak:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(Tshak.."Tshak:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ⦁ ارسل الان النص
 ⦁ يمكنك اضافه :
...
Redis:del(Tshak.."Tshak:Set:Id:Groups")
...
local Info_Members = Redis:smembers(Tshak.."Tshak:MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(Tshak.."Tshak:MosTafa:Ahmed"..msg_chat_id) 
...
if not msg.ControllerBot and not Redis:set(Tshak.."SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⦁ الاذاعه معطله من قبل المطور الاساسي *',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Tshak.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⦁ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:setex(Tshak.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Tshak.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Tshak.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Tshak.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Tshak.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
{
{text = '𓄼• ᴘʀᴏɢʀᴀᴍᴍᴇʀѕ ѕᴀɪᴅɪ •𓄹', url = "https://t.me/Dev_Source_Tshak"}
},
{
{text = '𓄼• سورس تشاك •𓄹', url = "https://t.me/sourceTshak"}
},
}
local msgg = msg_id/2097152/0.5
...
return LuaTele.sendText(msg_chat_id,msg_id,'𓄼• اليك قسم الالعاب من سورس تشاك •𓄹',"md",false, false, false, false, reply_markup)
end
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/sourceTshak'}, 
},
{
...
if text == (Redis:get(Tshak.."Tshak:Name:Bot") or "تشاك") then
local photo = LuaTele.getUserProfilePhotos(Tshak)
local UserInfo = LuaTele.getUser(Tshak)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
local CmdStart = '*\n ⦁ أهلآ بك في بوت '..(Redis:get(Tshak.."Tshak:Name:Bot") or "تشاك")..
...
Redis:del(Tshak.."Tshak:List:Manager"..'-100'..data.supergroup.id)
Redis:del(Tshak.."Tshak:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if tonumber(data.message.sender.user_id) == tonumber(Tshak) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Tshak..'Tshak:Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Sasa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:photo:Rank"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Sasa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:photo:Rank"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
Redis:srem(Tshak.."Tshak:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(Tshak.."Tshak:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Redisa:Groups") 
